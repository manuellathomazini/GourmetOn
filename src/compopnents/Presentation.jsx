...
const Presentation = () => {
  return (
    <div>
      <section id="apresentacao" className="py-24 bg-gradient-to-bl from-amber-900 to-white text-creme">
        <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
          <div>
            <h2 className="text-4xl md:text-5xl font-extrabold mb-6 leading-tight">
              GourmetOn
            </h2>
            <span className="inline-block bg-laranja/15 text-laranja text-xs font-bold px-4 py-2 rounded-full mb-5">
            ...
            <div className="space-y-6">
              <div className="flex gap-4 bg-white/5 border border-white/10 rounded-[2.5rem] p-3 shadow-2xl">
                <div className="w-11 h-11 shrink-0 rounded-xl bg-laranja/15 flex items-center justify-center text-xl">🛵</div>
                <div>
              ...
              <div className="flex gap-4 bg-white/5 border border-white/10 rounded-[2.5rem] p-3 shadow-2xl">
                <div className="w-11 h-11 shrink-0 rounded-xl bg-laranja/15 flex items-center justify-center text-xl">🍽️</div>
                <div>
